...
- [REST API concept page](https://alx-intranet.hbtn.io/concepts/45)
- [Learn REST: A RESTful Tutorial](https://www.restapitutorial.com/)
- [Designing a RESTful API with Python and Flask](https://blog.miguelgrinberg.com/post/designing-a-restful-api-with-python-and-flask)
- [HTTP access control (CORS)](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS)
- [Flask cheatsheet](./flask_cheatsheet.pdf)
...
**Solution [AirBnB_clone_v4](/AirBnB_clone_v4/)**
...
**Solution [models/engine/db_storage.py](../models/engine/db_storage.py), [models/engine/file_storage.py](../models/engine/file_storage.py), [tests/test_models/test_engine/test_db_storage.py](../tests/test_models/test_engine/test_db_storage.py), [tests/test_models/test_engine/test_file_storage.py](../tests/test_models/test_engine/test_file_storage.py)**
...
- Create a folder `views` inside `v1`:
    - create a file `__init__.py`:
        ...
        - wildcard import of everything in the package `api.v1.views.index` => PEP8 will complain about it, don’t worry, it’s normal and this file (v1/views/__init__.py) won’t be checked.
    - create a file `index.py`
        - import `app_views` from `api.v1.views`
        - create a route `/status` on the object `app_views` that returns a JSON: `"status": "OK"` (see example)

**Solution [api/__init__.py](__init__.py), [api/v1/__init__.py](v1/__init__.py), [api/v1/views/__init__.py](v1/views/__init__.py), [api/v1/views/index.py](v1/views/index.py), [api/v1/app.py](v1/app.py)**
...
**Solution [api/v1/views/index.py](v1/views/index.py)**
...
**Solution [api/v1/app.py](v1/app.py)**
...
**Solution [api/v1/views/states.py](v1/views/states.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/cities.py](v1/views/cities.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/amenities.py](v1/views/amenities.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/users.py](v1/views/users.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/places.py](v1/views/places.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/places_reviews.py](v1/views/places_reviews.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [api/v1/views/places_amenities.py](v1/views/places_amenities.py), [api/v1/views/__init__.py](v1/views/__init__.py)**
...
**Solution [models/base_model.py](../models/base_model.py), [models/user.py](../models/user.py)**
...
**Solution [api/v1/views/places.py](v1/views/places.py)**