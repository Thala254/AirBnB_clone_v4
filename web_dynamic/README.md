...
- [Manipulate DOM elements](https://jquery-tutorial.net/selectors/using-elements-ids-and-classes/)
...
**Solution [0-hbnb.py](0-hbnb.py), [templates/0-hbnb.html](templates/0-hbnb.html)**
...
**Solution [1-hbnb.py](1-hbnb.py), [templates/1-hbnb.html](templates/1-hbnb.html), [static/scripts/1-hbnb.js](static/scripts/1-hbnb.js)**
...
**Solution [api/v1/app.py](../api/v1/app.py), [web_dynamic/2-hbnb.py](2-hbnb.py), [web_dynamic/templates/2-hbnb.html](templates/2-hbnb.html),[ web_dynamic/static/styles/3-header.css](static/styles/3-header.css), [web_dynamic/static/scripts/2-hbnb.js](static/scripts/2-hbnb.js)**
...
- Request `http://0.0.0.0:5001/api/v1/places_search/`:
    - Description of this endpoint [here](../api/README.md#15-search). **If this endpoint is not available, you will have to add it to the API** (you can work all together for creating this endpoint)
    - Send a `POST` request with `Content-Type: application/json` and an empty dictionary in the body - cURL version: `curl "http://0.0.0.0:5001/api/v1/places_search" -XPOST -H "Content-Type: application/json" -d '{}'`
    - Loop into the result of the request and create an `article` tag representing a `Place` in the `section.places`. (you can remove the Owner tag in the place description)

The final result must be the same as previously, but now, places are loaded from the front-end, not from the back-end!

**Solution [web_dynamic/3-hbnb.py](3-hbnb.py), [web_dynamic/templates/3-hbnb.html](templates/3-hbnb.html), [web_dynamic/static/scripts/3-hbnb.js](static/scripts/3-hbnb.js)**
...
**Solution [web_dynamic/4-hbnb.py](4-hbnb.py), [web_dynamic/templates/4-hbnb.html](templates/4-hbnb.html), [web_dynamic/static/scripts/4-hbnb.js](static/scripts/4-hbnb.js)**
...
**Solution [web_dynamic/100-hbnb.py](100-hbnb.py), [web_dynamic/templates/100-hbnb.html](templates/100-hbnb.html), [web_dynamic/static/scripts/100-hbnb.js](static/scripts/100-hbnb.js)**
...
- Design the list of reviews from this [task](../web_static/README.md#9-full-details)
...
**Solution [web_dynamic/101-hbnb.py](101-hbnb.py), [web_dynamic/templates/101-hbnb.html](templates/101-hbnb.html), [web_dynamic/static/scripts/101-hbnb.js](static/scripts/101-hbnb.js)**
