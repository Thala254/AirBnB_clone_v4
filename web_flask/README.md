...
**Solution [0-hello_route.py](0-hello_route.py), [__init__.py](__init__.py)**
...
**Solution [1-hbnb_route.py](1-hbnb_route.py)**
...
**Solution [2-c_route.py](2-c_route.py)**
...
**Solution [3-python_route.py](3-python_route.py)**
...
**Solution [4-number_route.py](4-number_route.py)**
...
**Solution [5-number_template.py](5-number_template.py), [templates/5-number.html](templates/5-number.html)**
...
**Solution [6-number_odd_or_even.py](6-number_odd_or_even.py), [templates/6-number_odd_or_even.html](templates/6-number_odd_or_even.html)**
...
**Solution [models/engine/file_storage.py](../models/engine/file_storage.py), [models/engine/db_storage.py](../models/engine/db_storage.py), [models/state.py](../models/state.py)**
...
- Import this [7-dump](../dumps/7-dump.sql) to have some data
- You must use the option `strict_slashes=False` in your route definition

**IMPORTANT**

- Make sure you have a running and valid `setup_mysql_dev.sql` in your `AirBnB_clone_v2` repository ([Task](../setup_mysql_dev.sql))
...
**Solution [web_flask/7-states_list.py](7-states_list.py), [web_flask/templates/7-states_list.html](templates/7-states_list.html)**
...
**Solution [web_flask/8-cities_by_states.py](8-cities_by_states.py), [web_flask/templates/8-cities_by_states.html](templates/8-cities_by_states.html)**
...
**Solution [web_flask/9-states.py](9-states.py), [web_flask/templates/9-states.html](templates/9-states.html)**
...
- After each request you must remove the current SQLAlchemy Session:
    ...
    - Call in this method `storage.close()`
- Routes:
    - `/hbnb_filters`: display a HTML page like `6-index.html`, which was done during the project [0x01. AirBnB clone - Web static](../web_static)
...
- You must use the option `strict_slashes=False` in your route definition
- Import this [10-dump](../dumps/10-dump.sql) to have some data
...
**Solution [web_flask/10-hbnb_filters.py](10-hbnb_filters.py), [web_flask/templates/10-hbnb_filters.html](templates/10-hbnb_filters.html), [web_flask/static/](static/)**
...
- After each request you must remove the current SQLAlchemy Session:
    ...
    - Call in this method `storage.close()`
- Routes:
    - `/hbnb`: display a HTML page like `8-index.html`, done during the [0x01. AirBnB clone - Web static](../web_static) project
...
- You must use the option `strict_slashes=False` in your route definition
- Import this [100-dump](../dumps/100-dump.sql) to have some data
...
**Solution [web_flask/100-hbnb.py](100-hbnb.py), [web_flask/templates/100-hbnb.html](templates/100-hbnb.html), [web_flask/static/](static/)**